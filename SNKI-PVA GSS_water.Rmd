...
$$
\Delta_{std}\text{Growth rate} = \frac{\mathbf{A}+\mathbf{B}\hat{\mu}-(\mathbf{A}+\mathbf{B}\hat{\mu}-\hat{\beta}\text{W}^2)}{\mathbf{A}+\mathbf{B}\hat{\mu}} 
$$

which is reduced to 
$$
\Delta_{std}\text{Growth rate} = \frac{\hat{\beta}\text{W}^2}{\mathbf{A}+\mathbf{B}\hat{\mu}} 
$$
...
plot(W.sim, std.gr.mat[,1], ylab = "Standardized change in growth rate", xlab = "Centered water level")
